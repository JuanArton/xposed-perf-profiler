...
class OrientationHook : IXposedHookZygoteInit, IXposedHookLoadPackage {
    ...
    override fun handleLoadPackage(lpparam: XC_LoadPackage.LoadPackageParam) {
        ...
        findMethod("com.android.server.wm.DisplayRotation") {
            ...
            backgroundHandler.post {
                ...
                threadHandler.post {
                    try {
                        val newRotation = param.args[0] as Int
                        XposedBridge.log("Screen is about to rotate to: $newRotation")
